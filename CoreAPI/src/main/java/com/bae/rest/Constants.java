...
public class Constants {
	...
	public static final String VEHICLE_LOCATION_URL = "http://localhost:8004/getLocationsByRegistrationNo/";
	public static final String VEHICLE_REGISTRATION_URL = "http://localhost:8004/getVehiclesByRegistrationNo/";
